...
### 날짜
- [ ] 요일, 특별날짜, 25일까지의 날짜, 평일, 주말로 구분
- [ ] 1일부터 31일까지
- [ ] 특별 할인 날짜 저장(3, 10, 17, 24, 25, 31)

### 뱃지
- [ ] 5천원 이상 10000원 미만 별
- [ ] 10000원 이상 20000원 미만 별
- [ ] 20000원 이상 산타
...
### 평일 할인
- [ ] 평일(일~목) 디저트 메뉴 2023원씩 할인

### 주말 할인
- [ ] 주말(금~토) 메인 메뉴 2023원씩 할인
...
### 증정이벤트
- [ ] 총주문 금액 생성자로 받아옴
- [ ] 총주문금액 12만원 이상이면 증정품(샴페인 25000원) 증정

### 이벤트 배지 선정
- [ ] 총혜택금액 생성자로 받아옴
- [ ] 5000~10000 : 별, 10000~20000 : 트리, 20000~ : 산타
...
### 재입력
- [ ] 잘못된 값이 입력될 경우 IllegalArgumentException
- [ ] '[ERROR]' 로 시작하는 메시지 출력
- [ ] 오류가 발생한 부분부터 재입력
